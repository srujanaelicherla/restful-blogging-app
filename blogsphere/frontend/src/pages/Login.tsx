      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45, delay: 0.08 }}
          ...
          <div className="p-8">
            ...
            <p className="text-sm text-[#6a6460] mb-8">Sign in to continue writing</p>
          ...
          <div className="px-8 py-5 border-t border-white/[0.05] text-center">
            <p className="text-sm text-[#4a4440]">
              No account yet?{' '}
              <Link to="/register" className="text-amber-400 hover:text-amber-300 transition-colors font-medium">Create one</Link>
            </p>
          </div>
        </motion.div>
      </div>
