      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        >
          ...
          <div className="p-8">
            ...
            <p className="text-sm text-[#6a6460] mb-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-[#5a5450] uppercase tracking-widest">
                  Email
                </label>
                <input
                  type="email"
        ...
        <motion.p
          ...
          className="text-center text-xs text-[#2a2420] mt-6"
        >
